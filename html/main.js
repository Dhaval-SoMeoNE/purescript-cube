...
(function(exports) {
  ...
  var scene = function (rotX) {
      return Graphics_Drawing.translate(550.0)(300.0)(Graphics_Isometric.renderScene({
          x: -1.5, 
          y: -3.5, 
          z: 3.5
      })(Graphics_Isometric.scale(80.0)(Graphics_Isometric.rotateZ(rotX)(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.grey)(Graphics_Isometric.prism(Graphics_Isometric_Point.point(-1.5)(-1.5)(-1.5))(3.0)(3.0)(3.0))))));
  };
  ...
  var fun = function (rotX) {
      return function __do() {
          ...
          var v2 = clearCanvas(v1)();
          return Graphics_Drawing.render(v1)(scene(rotX))();
      };
  };
  ...
  var rotateCube = function (angle) {
      return function __do() {
          fun(angle)();
          var newSpeed = $foreign.getSpeed(angle);
          var $15 = newSpeed < 20.0;
          if ($15) {
              return Data_Unit.unit;
          };
          var timep = 20000 / abs(Data_Maybe.fromMaybe(200)(Data_Int.fromNumber($$Math.trunc(newSpeed)))) | 0;
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Timer.setTimeout(timep)(rotateCube(angle + 0.1)))();
      };
  };
  var startMouseHandlers = function __do() {
      ...
      var downHandler = function (event) {
          return function (jq) {
              return function __do() {
                  ...
                  var v3 = Signal_Time.now();
                  var upHandler = function (event$prime) {
                      return function (jq$prime) {
                          return function __do() {
                              var v4 = Control_Monad_Eff_JQuery.getPageX(event$prime)();
                              var v5 = Control_Monad_Eff_JQuery.getPageY(event$prime)();
                              var v6 = Signal_Time.now();
                              var dx = v4 - v1;
                              var temp = ((v1 - v4) / (v3 - v6)) * 500.0;
                              var speed = (function () {
                                  var $23 = $foreign.getSpeed(temp) === 0.0;
                                  if ($23) {
                                      return $foreign.changeSpeed(temp);
                                  };
                                  return $foreign.changeSpeed(0.0);
                              })();
                              return rotateCube(0.0)();
                          };
                      };
                  };
  ...
  exports["changeSpeed"] = $foreign.changeSpeed;
  exports["flag"] = $foreign.flag;
